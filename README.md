...
- The workflow reviewer reads only nine relationship fields from each parser summary through SQLite's bundled JSON projection; large page, vision, CAD and geometry arrays are not transferred to Python for RFI/Submittal/Email indexing.
