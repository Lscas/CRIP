...
- A reviewer may compare detected and effective workflow metadata, then apply or reset an exact current-run RFI/Submittal/Other correction. The versioned overlay never rewrites parser data or hides explicit Email attachment provenance, and starts no model call.
