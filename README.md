...
- Explicit Sheet/Drawing/Dwg identifiers remain whole and stay with the same RFI/Submittal identity or source finding. Prefix variants, case and dash glyphs normalize, while identifier content remains exact and cannot be borrowed or recombined. Exact Sheet locators may supply their own identifier; unlabelled codes are excluded and CIRP does not infer applicability or authority.
