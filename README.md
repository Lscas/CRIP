...
- Explicit Sheet/Drawing/Dwg/Detail identifiers remain whole and stay with the same RFI/Submittal identity or source finding. Slash-form detail callouts such as `3/A5.1` remain atomic. Prefix variants, case and dash glyphs normalize, while identifier content remains exact and cannot be borrowed or recombined. Exact Sheet locators may supply their own identifier; unlabelled codes are excluded and CIRP does not infer applicability or authority.
- Explicit dotted Paragraph/Para, Clause and Article identifiers remain whole and workflow-scoped. Paragraph/Para formatting normalizes, while the typed reference and dotted value remain exact. Exact Paragraph locators may supply only their corresponding Paragraph identifier; unlabelled, undotted and date-shaped values are excluded.
