...
- Primary workflow routing ranks explicit Subject, body heading, then filename; other exact identifiers stay references and cannot donate role or status.
...
- For email documents, Subject outranks body heading and filename; other exact identifiers remain reference-only and cannot donate role or status.
