...
- Attachment listing, including non-root multipart/related resources without filenames or disposition, returns only bounded metadata and SHA-256; raw bytes are not returned.
