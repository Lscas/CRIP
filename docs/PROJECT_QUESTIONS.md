...
- A 12,000-fragment synthetic production-path benchmark with term expansion measured about 454 ms per complete compatibility scan versus 52 ms with FTS5 (about 8.8x); results vary by computer and corpus.
