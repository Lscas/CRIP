...
From, To, Cc and Date remain visible email-header evidence but cannot create RFI or Submittal workflow references. Subject, current body and explicit quoted history remain eligible for exact reference extraction.
