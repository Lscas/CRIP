...
EML: one plain/HTML body; related root only. Resources/history/signatures/nested messages stay inert. Unnamed imports use MIME extensions. Body-routed sections cannot cross-donate fields; valid Subject priority remains.
