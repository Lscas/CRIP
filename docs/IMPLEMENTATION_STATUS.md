...
| Parsing | TXT/DOCX; EML/MSG body/history, headers, exact Gmail/Outlook wrappers, inert attachments and workflow/thread metadata; PDF structure/tables, OCR, bounded splitting/progress and 1/2/4-worker page chunks | Mailbox sync, recursive attachments, semantic threads, unknown quote wrappers, borderless/cross-page tables, multi-column order, revision/comments, footnotes and graphic semantics |
