...
EML prefers plain text, else safe HTML; history/signatures/attachments stay inert. Exact IDs persist; malformed/fuzzy/address forms stay unlinked. Official Response is RFI-only. Review/Final/Submittal Response accepts known dispositions only; no precedence/authority inference. Route: Subject, body, filename.
