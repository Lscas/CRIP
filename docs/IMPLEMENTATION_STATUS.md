...
EML prefers non-empty plain text, otherwise safe HTML. History/signature evidence stays reviewable but cannot route or enter extraction; attachments remain inert. Exact digit-bearing prefixes persist across TXT, Email and filenames, while malformed, prose, address and fuzzy variants stay unlinked. Primary route order is Subject, body, then filename.
