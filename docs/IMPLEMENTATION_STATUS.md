...
EML chooses plain text, then safe HTML. History/signatures stay out of extraction; attachments stay inert. Exact IDs persist across TXT/Email/filenames; malformed, address and fuzzy forms stay unlinked. Official Response maps only at a heading boundary; named Submittal stamps reuse existing groups without deciding authority. Route: Subject, body, filename.
