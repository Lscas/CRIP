...
EML chooses plain text, then safe HTML. History/signatures are review-only and not extracted; attachments stay inert. Exact digit-bearing IDs persist across TXT/Email/filenames; malformed, prose, address and fuzzy forms stay unlinked. Exact Furnish as Submitted/Corrected and Amend and Resubmit reuse existing groups without deciding authority. Route: Subject, body, filename.
