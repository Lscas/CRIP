...
EML: one plain/HTML body; related root only. Other resources/history/signatures/nested messages stay inert. Unnamed imports use standard MIME extensions. Exact IDs dedupe; fuzzy/address forms do not link.
